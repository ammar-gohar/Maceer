<x-layouts.reports title="{{ App::isLocale('ar') ? 'تقديرات المقررات' : 'Enrollments' }}">
    <div class="row">
        <div class="mb-4 text-center col-md-12 fs-3">
            <strong>{{ App::isLocale('ar') ? 'تقديرات المقررات' : 'Enrollments' }}</strong>
        </div>
    ...
    <div class="mb-2 row">
        <div class="mb-2 row">
            <div class="container">
                ...
                <div class="row">
                    <p><strong>@lang('modules.students.total_earned_credits'):</strong> {{ Auth::user()->student->total_earned_credits }}</p>
                </div>
            </div>
        </div>
        <div class="mb-2 row">
