<x-page title="sidebar.reports.receipt_register" module="reports">
    ...
    <div class="card-body">
        ...
        <div class="p-2 my-3 row" style="font-size: 1rem;">
            <div>
                <input type="text" name="search" id="search" wire:model.live='search' placeholder="{{ App::isLocale('ar') ? 'ابحث باسم الطالب أو الرقم الأكاديمي...' : 'Search with student name or academic number...' }}" class="form-control">
            </div>
        </div>
        {{-- /FILTERS --}}
        @if ($receipts->count() > 0)
