<x-page module="halls" title="sidebar.halls.create" show_index_button="true" show-delete-button="true">
    ...
    <form wire:submit='update()'>
        ...
        <div class="mt-3 card-footer">
            <button type="submit" class="btn btn-dark" type="submit" wire:loading.attr='disabled' wire:target='update'>
            ...
            <button type="button" class="border btn btn-light" type="button" wire:click='resetBtn()'>@lang('forms.reset')</button>
        </div>
        <!--end::Footer-->
    </form>
    <!--end::Form-->
