<x-page module="courses" title="sidebar.courses.requests">
    ...
    @else
        <div class="container my-3">
            ...
            <div class="mb-2 row">
                <h6 class="col-6">@lang('modules.students.guide'): {{ Auth::user()->student->guide->first_name . ' ' . Auth::user()->student->guide->last_name }}</h6>
                <h6 class="text-danger col-6">@lang('modules.courses.enrollment_end'): {{ $enroll_end }}</h6>
            </div>
        </div>
        <!--begin::Form-->
