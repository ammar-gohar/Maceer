                            ...
                            <tr class="align-middle" style="white-space: nowrap;">
                                ...
                                <td style="white-space: nowrap;">
                                    ...
                                    @can('students.guidence')
                                        @unless (Auth::user()->hasRole('Super Admin'))
                                            @if ($semesterId)
                                                @if ($student->receipt_paied_at && $student->enrollments && !$student->enrollments->first()->approved_at)
                                                    <button class="btn btn-sm btn-danger"
                                                ...
                                                @elseif($student->receipt_paied_at && $student->enrollments && $student->enrollments->first()->approved_at)
                                                    {{ App::isLocale('ar') ? 'مُصدق في:' : 'Approved at: ' }}{{ $student->enrollments->first()->approved_at }}
                                                @else
