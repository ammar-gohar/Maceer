<div class="mx-auto my-4 card card-info card-outline" style="width: 90%;">
    ...
    <div class="px-4 card-header d-flex justify-content-between align-items-center">
        ...
        <div class="text-end w-50">
            <button wire:click='goToRoles()' class="btn btn-info ms-auto">@lang('sidebar.roles.index')</button>
        </div>
    </div>
    <!--end::Header-->
    @if ($status)
        <div class="mx-auto mt-2 alert alert-success w-75">
            @lang('modules.roles.success.create')
        </div>
    @endif
    <!--begin::Form-->
