        ...
        <form wire:submit='update_quiz()'>
            ...
            <div class="mt-3 card-footer">
                @if ($currentTab['show'] == 2)
                    <button type="submit" class="btn btn-dark" type="submit" wire:loading.attr='disabled' wire:target='update_quiz'>
                        <div class="mx-2 spinner-border spinner-border-sm" role="status" wire:loading wire:target='update_quiz'>
                            <span class="text-sm visually-hidden"></span>
                        </div>
                        <span wire:loading wire:target='update_quiz'>@lang('forms.editing')</span>
                        <span wire:loading.remove wire:target='update_quiz'>@lang('forms.edit')</span>
                    </button>
                @endif
