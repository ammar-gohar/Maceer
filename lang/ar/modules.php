...
return [
    'roles' => [
        'show' => 'عرض نوع المستخدم',
        'index' => 'عرض انواع المستخدمين',
        'title' => 'نوع المستخدم',
    ...
    'students' => [
        ...
        'success' => [
            ...
            'enrollment_approved' => 'ووفق على تسجيل المقررات',
        ],
        'create' => 'إضافة طالب',
    ...
    'moderators' => [
        ...
        'show' => 'عرض بيانات عضو الادارة :name',
        'create' => 'إضافة عضو',
        'success' => [
            'update' => 'نجح تعديل بيانات العضو',
            'store' => 'نجح إنشاء عضو جديد',
        ]
    ],
