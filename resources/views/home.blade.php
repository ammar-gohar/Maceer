              ...
              <div class="col-lg-3 col-6">
                ...
                <div class="small-box text-bg-primary">
                  <div class="inner">
                    ...
                    <p>@lang('home.students_count')</p>
                  </div>
                  <i class="small-box-icon fa-solid fa-user-graduate"></i>
                  <a
                    href="{{ route('students.index') }}"
                    class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover"
                  >
                    @lang('sidebar.students.index') <i class="bi bi-link-45deg"></i>
                  </a>
                </div>
              ...
              <div class="col-lg-3 col-6">
                ...
                <div class="small-box text-bg-primary">
                  <div class="inner">
                    ...
                    <p>@lang('home.professors_count')</p>
                  </div>
                  <i class="small-box-icon fa-solid fa-chalkboard-user"></i>
                  <a
                    href="{{ route('professors.index') }}"
                    class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover"
                  >
                    @lang('sidebar.professors.index') <i class="bi bi-link-45deg"></i>
                  </a>
                </div>
                <!--end::Small Box Widget 1-->
              </div>
              ...
              <div class="col-lg-3 col-6">
                ...
                <div class="small-box text-bg-primary">
                  <div class="inner">
                    ...
                    <p>@lang('home.moderators_count')</p>
                  </div>
                  <i class="small-box-icon fa-solid fa-user-gear"></i>
                  <a
                    href="{{ route('moderators.index') }}"
                    class="small-box-footer link-light link-underline-opacity-0 link-underline-opacity-50-hover"
                  >
                    @lang('sidebar.moderators.index') <i class="bi bi-link-45deg"></i>
                  </a>
                </div>
                <!--end::Small Box Widget 1-->
              </div>
